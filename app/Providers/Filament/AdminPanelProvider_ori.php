            ...
            ->renderHook(
                ...
                fn (): string => '<script>
                    document.addEventListener("DOMContentLoaded", () => {
                        ...
                        // 6. FITUR AUTO FREEZE 3 KOLOM KIRI
                                ...
                                table.querySelectorAll("tr").forEach(row => {
                                    ...
                                    for (let i = 0; i < 3; i++) {
                                        if (cells[i]) {
                                            ...
                                            cells[i].style.zIndex = cells[i].tagName === "TH" ? "50" : "10";
                                            
                                            if (i === 2) {
                                                cells[i].style.borderRight = document.documentElement.classList.contains("dark") 
                                                    ? "1px solid #3f3f46" 
                                                    : "1px solid #cbd5e1";
                                            }
                                        }
